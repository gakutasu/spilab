...
17 分野・175 問（2026-09-18 時点）。各分野 8〜11 問。

- 言語：語彙 11 / 二語関係 11 / 熟語 11 / 語句の意味 11 / 文の並べ替え 10 / 長文読解 8
- 非言語：割合 10 / 損益 10 / 速度 10 / 仕事算 10 / 順列 11 / 組合せ 11 / 確率 11 / 推論 10 / 集合 10 / 表の読み取り 10 / 資料読み取り 10

すべての問題は作成後に、解説を見ずに独立して解き直す検証を経ています（非言語は数値の再計算・総当たり列挙、言語は別解の有無の確認）。
